    ...
    <footer className="footer">
      <div className="footer-wave">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 100" preserveAspectRatio="none">
          <path fill="var(--cream)" d="M0,0 C480,100 960,100 1440,0 L1440,0 L0,0 Z"></path>
        </svg>
      </div>
      ...
      <div className="container">
        <div className="footer-content">
          <div className="footer-brand">
            <img src="/real logo.jpg" alt="Sarah Baker Coffee" className="footer-logo" />
            <h3>Sarah Baker Coffee</h3>
            <p>La première Boulangerista</p>
            <p className="slogan">❤️ Je t'aime, je te mange ❤️</p>
          </div>
        ...
        <div className="footer-bottom">
          <p>© {currentYear} Sarah Baker Coffee. Tous droits réservés.</p>
          <p className="made-with">Fait avec ☕ et 🥐 à Châtenay-Malabry</p>
        </div>
      </div>
    </footer>
  )
